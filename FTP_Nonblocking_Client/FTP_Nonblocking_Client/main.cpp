            ...
            while(1) {
                ...
                if ( (n = read(sockfd, buf, read_bytes)) < 0) {
                    ...
                    if ( (nwritten = write(fileno(client_file), buf, n)) < 0) {
                        ...
                        printProgress((double ) (current_file_size/file_size));
            ...
            if(strcmp(buf, "/exit\n") == 0) {
                ...
                if(strcmp(pch, "/put") == 0) {
                    ...
                    while(!feof(client_file)){
                        ...
                        current_send += numbytes;
                        printProgress((double )(current_send/file_size));
                    }
